...
**public** \<<u>E</u>\> SinglyLinkedList\<E\>
concatenateLists(SinglyLinkedList\<E\> L1,
...
**if**(size\<2) **throw** **new** IllegalStateException("list must have
2 or more entries");
...
//if( n\<0 ) throw new IllegalStateException("String must have one or
more chars");
...
**boolean**\[ \] found = **new** **boolean**\[A.length\]; // all
